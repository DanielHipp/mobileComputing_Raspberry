...
If the received strings only contains zeros and is 256 (16x16) numbers long and an identifier letter, described in \ref{Communication between the Client and Server}. It will be interpreted as an binary image and directly outputted on the dot matrix.
